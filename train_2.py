...
from cityscapes_2 import CityScapes
...
def parse_args():
    ...
    parse.add_argument('--is_check',dest='check',type=bool, default=False)
    ...
    parse.add_argument('--max_iter',dest = 'max_iter', type = int,default = 15000,)
    ...
    parse.add_argument( '--respath',   dest = 'respath',type = str, default = './checkpoints/ICAICE/11.6_batch8_15000it_GRAY_STDC813_1XDF12CBAM2345_0.5XCBAM3_2',)
