...
if __name__ == '__main__':
    # initial net
    save_pth = '/media/wlj/soft_D/WLJ/WJJ/STDC-Seg/checkpoints/ICAICE/11.6_batch8_15000it_GRAY_STDC813_1XDF12CBAM2345_0.5XCBAM3/model_maxmIOU100.pth'
    model = initialize_net(save_pth)

    ## inference file
    # imgs_path = "camera_4_crop/leftImg8bit/test/nok"
    # labels_path = "camera_4_crop/gtFine/test/nok"
    # img_savepth = 'result/batch8_10.22_15000it_stdc813_DFConv12_CBAM2345_gray'
    # file_inference(imgs_path,labels_path,model,img_savepth)

    imgs_bootpath = "camera_4_crop/leftImg8bit/test"
    labels_bootpath = "camera_4_crop/gtFine/test"

    imgs_classes = os.listdir(imgs_bootpath)
    labels_classes = os.listdir(labels_bootpath)

    assert imgs_classes==labels_classes
    start = time.time()
    for imgs_class in imgs_classes:
        imgs_path = os.path.join(imgs_bootpath,imgs_class)
        labels_path = os.path.join(labels_bootpath,imgs_class)
        img_savepth = 'result/11.6_batch8_15000it_GRAY_STDC813_1XDF12CBAM2345_0.5XCBAM3'
        file_inference(imgs_path, labels_path, model, img_savepth)
