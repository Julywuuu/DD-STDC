...
from nets.stdcnet_simplify import STDCNet1446, STDCNet813
...
class ContextPath(nn.Module):
    ...
    def forward(self, x):
        ...
        avg = self.conv_avg(avg)                    #conv br 512,128,1,1
        ...
        return feat2, feat4, feat8, feat16, feat16_up # x8, x16
